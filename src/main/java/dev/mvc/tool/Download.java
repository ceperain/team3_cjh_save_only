...
// dev.mvc.team3_v2sbm3c.ServletRegister.java에서 등록
public class Download extends javax.servlet.http.HttpServlet {
  ...
  protected void doProcess(HttpServletRequest request,
    ...
    // 저장 폴더를 절대 경로로 변환, /review/storage
    String dir = request.getParameter("dir");
    if (dir.equals("/review/storage")) {
        dir = Contents.getUploadDir();  // C:/kd/deploy/team3_v2sbm3c/review/storage/
    }
...
//    } 
    ...
    // 수정된 dir: C:/kd/deploy/team3_v2sbm3c/review/storage/
