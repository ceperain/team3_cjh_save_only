...
drop SEQUENCE keylist_seq;
CREATE SEQUENCE keylist_seq
  START WITH 1                -- 시작 번호
  INCREMENT BY 1            -- 증가값
...
values(keylist_seq.nextval, '가성비 좋아요~!');

insert into keylist(keylistno, keytext)
values(keylist_seq.nextval, '친절해요~!');

insert into keylist(keylistno, keytext)
values(keylist_seq.nextval, '분위기가 좋아요~!');

insert into keylist(keylistno, keytext)
values(keylist_seq.nextval, '재료가 신선해요~!');

insert into keylist(keylistno, keytext)
values(keylist_seq.nextval, '청결해요~!');
